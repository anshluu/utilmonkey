// Source Extracted from https://github.com/MauriceButler/crypton. Thank you.
...
function crypton(secret) {
    if (!secret || typeof secret !== 'string') {
        throw new Error('crypton: secret must be a non-0-length string');
    }
